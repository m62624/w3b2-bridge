...
### Команды для запуска w3b2
solana-test-validator --reset

anchor build 

solana program deploy target/deploy/w3b2_bridge_program.so --program-id assets/w3b2_bridge_program-keypair.json

cargo run w3b2-connector
